...
describe('Input component', function () {
    ...
    it('renders an input with all the provided props', function () { return __awaiter(void 0, void 0, void 0, function () {
        var placeholder, value, type, state, customClass, validations, errors, listenChange, listenForm, listenFocus, preppendClass, iconLeft, wrapper, inputElement;
        return __generator(this, function (_a) {
            ...
            listenForm = false;
            listenFocus = false;
            preppendClass = 'test-prepend-class';
            iconLeft = 'test-icon.png';
            wrapper = mountFunction(Input_vue_1["default"], {
                props: {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    textInput = wrapper.find("input[placeholder=\"" + placeholder + "\"]");
    ...
    it('should emit onFocus when focused input', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    inputElement = wrapper.find("input[placeholder=\"" + placeholder + "\"]");
    ...
    it('should render errors correctly when trigger blur event on input', function () { return __awaiter(void 0, void 0, void 0, function () {

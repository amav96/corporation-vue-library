...
describe('TextArea component', () => {
  ...
  it('renders an TextArea with all the provided props', async () => {
    ...
    const wrapper = mountFunction(TextArea, {
      props: {
        placeholder,
        value,
        type,
  ...
  it('should emit update:model-value typing', async () => {
    ...
    const textInput = wrapper.find(`textarea[placeholder="${placeholder}"]`)
  ...
  it('should emit onFocus when focused TextArea', async () => {
    const placeholder = 'Test Placeholder';
    const value = '';
    ...
    const textInput = wrapper.find(`textarea[placeholder="${placeholder}"]`)
    await textInput.setValue(write)
    const inputElement = wrapper.find(`textarea[placeholder="${placeholder}"]`)
  ...
  it('should render errors correctly when trigger blur event on TextArea', async () => {
    const placeholder = 'Test Placeholder';
    const value = '';
    const validations = { rules: { required: true } };
